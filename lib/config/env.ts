...
const envSchema = z.object({
	...
	// Cliente público para la aplicación móvil de Biblia Kids: sin secreto, login con
	...
	SESSION_COOKIE_NAME: z.string().min(1).default('biblia_kids_session'),
	SESSION_TEMP_COOKIE_NAME: z.string().min(1).default('biblia_kids_oauth_state'),
