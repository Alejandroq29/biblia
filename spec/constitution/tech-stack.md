# Tech Stack y Convenciones — Biblia Kids
...
Los tests deben cubrir los flujos propios de **Biblia Kids**, incluyendo la consulta del contenido bíblico, historias bíblicas, juegos educativos, niveles de dificultad, progreso del usuario, favoritos y planes de lectura.
...
Para las funcionalidades de Biblia Kids, se deben incluir como mínimo casos de acceso al contenido adecuado, progreso y desbloqueo de niveles, puntuación de juegos, aislamiento de datos entre usuarios y validación de los planes de lectura.
