...
router.post(async (req, res) => {
	...
	const syncedUser = await findOrSyncByOAuth(
	...
	if (!syncedUser) {
		throw new AuthenticationError('No se pudo sincronizar el usuario.');
	}

	const sessionId = await sessionService.create(syncedUser.id, {
