...
// crear la identidad real de un usuario. Usa el cliente de servicio `biblia-kids-registration-service`
...
/** Compensación: si el registro local falla, se revierte la creación en Keycloak. */
